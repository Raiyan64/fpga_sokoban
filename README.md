...
3. Import the block design located from the top_folder directory.
4. Add the RealDigital HDMI Encoder IP (ip_repo/RD_hdmi_ip2020.zip) and our Graphics Controller IP (ip_repo/gb_gpu_1_0.zip) by extracting and adding to the project's IP catalog.
